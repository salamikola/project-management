...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"> <center> <b> {{ __('Registration form for new users') }} <b> </center> </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="lastName" type="text" class="form-control @error('firstName') is-invalid @enderror" name="lastName" value="{{ old('lastName') }}" required autocomplete="lastName">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="dob" type="date" class="form-control @error('firstName') is-invalid @enderror" name="dob" value="{{ old('dob') }}" required autocomplete="dob">
